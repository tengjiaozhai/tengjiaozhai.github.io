...
目的是把它的核心思路搬进公司内部：维修工拿着板子能自己定位故障，不用等资深工程师来指路；新人拿到一套图纸，不用师傅坐旁边一句一句教，自己就能顺着管线跑通原理图。降低门槛，缩短排查周期。

**官网：** https://wrenchboard.cloud | **GitHub：** https://github.com/Junkz3/wrench-board

这篇预研记录的是看懂原理图这条路——从 PDF 到结构化电路数据，再到自动诊断推理，实际跑通这个流程踩过的坑。两份文档的关系：README 讲产品是什么，这篇讲底层的 PDF→JSON 管线怎么造出来的。
...
![](images/ai/Pasted image 20260630174010.png)
